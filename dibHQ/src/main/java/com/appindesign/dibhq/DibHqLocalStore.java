package com.appindesign.dibhq;
	...
	public class DibHqLocalStore extends ContentProvider 
	{
	    public static final String PROVIDER_NAME = "com.appindesign.dibhq.DibHqLocalStore";
	    ...
	    private static class DatabaseHelper extends SQLiteOpenHelper 
	    {
	        ...
	        int newVersion) 
	        {
	            //New
	        	if ( oldVersion == 1) {
	        		db.execSQL( "ALTER TABLE " + DATABASE_TABLE + " RENAME TO tmp_table_name;" );
	        		onCreate(db);
//	        		db.execSQL( DATABASE_CREATE );        		
	        		db.execSQL( 
	        			"INSERT INTO " + DATABASE_TABLE + 
	        			" ( COL_FORENAME, COL_SURNAME, COL_CLUB, " +
	        			"COL_CLASSIFICATION, COL_IDENTIFIER, COL_NAME, COL_STATUS, COL_OLD_TIME ) " + 
	        			"SELECT COL_FORENAME, COL_SURNAME, COL_CLUB, COL_CLASS, COL_ID, COL_COURSE, COL_STATUS, COL_TIME" +  
	        			" FROM tmp_table_name;" );
